...
class NLI(nn.Module):
    def __init__(self):
        ...
        self.mlp.append(nn.Linear(1024, 512))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(512, 512))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(512, 512))
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.mlp = nn.ModuleList()
        self.mlp.append(nn.Linear(128, 256))
        self.mlp.append(nn.LeakyReLU())
...
class LatentGenerator(nn.Module):
    def __init__(self):
        ...
        self.mlp = nn.ModuleList()
        self.mlp.append(nn.Linear(128, 512))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(512, 512))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(512, 128))
...
class LatentDiscriminator(nn.Module):
    def __init__(self):
        ...
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(1024, 1024))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(1024, 1))
...
class WDiscriminator(nn.Module):
    def __init__(self):
        ...
        self.mlp = nn.ModuleList()
        self.mlp.append(nn.Linear(512, 1024))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(1024, 1024))
        self.mlp.append(nn.LeakyReLU())
        self.mlp.append(nn.Linear(1024, 1))
